package ru.realtorcrm.price_history.service;
...
import ru.realtorcrm.price_history.dto.EstateDto;
...
public class EstateProcessorService {
    ...
    private static final String UPSERT_SQL =
            "INSERT INTO estates_history (cadastre, type, square, price, source, load_date) " +
                    "VALUES (?, ?, ?, ?, ?, ?) " +
                    "ON CONFLICT (cadastre, source, load_date) DO UPDATE SET " +
                    "type = EXCLUDED.type, " +
